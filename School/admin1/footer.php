                        ...
                        <form action="" method="">
                            <table>
                                <tr>
                                    ...
                                    <td><input type="text" name="copyright" value="Enter your copyright text"/></td>
                                </tr>
                                <tr>
                                    <td>Footer Right Text:</td>
                                    <td><input type="text" name="righttext" value="Enter your right text"/></td>
                                </tr>
                                <tr>
                                    <td></td>
                                    <td><input type="submit" name="submit" value="Cange Footer"/></td>
                                </tr>
                            </table>
                        </form>
                    </div>
